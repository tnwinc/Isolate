...
(function() {
  ...
  (function(root, factory) {
    ...
    var IsolationContext, IsolationFactory, build_dependencies, getMatcherForPath, getType, isolatedContextNameNumber, isolationContextNumber, passthru;
    ...
    IsolationContext = (function() {
      ...
      IsolationContext.prototype.newContext = function(name) {
        ...
        name = name || ("isolation_context_" + (isolationContextNumber++));
