(function() {
  var IsolationContext, IsolationFactory, build_dependencies, getRegExpForPath, getType, isolate_has_been_configured, passthru,
  ...
  getRegExpForPath = function(path) {
    var path_type, regex;
